//
//  Please select "Sketch > Show sketch folder" from the menu,
//  and copy the contents of SD subdirectory to SD card.
//
...
void demo();
void testWiFi();
RunMode showModeSelectionScreen (RunMode default_mode, int wait_until_default);
